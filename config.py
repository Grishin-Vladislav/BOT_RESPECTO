...
characteristics_sample = {
    ...
    'K': ('используешь эмодзи, смайлы, восклицательные знаки, многоточия', 'пишешь с маленькой буквы', 'используешь скобочки например ))) или (( вместо эмодзи', 'пишешь капслоком когда хочешь подчеркнуть свою мысль', 'сравниваешь себя или других с известными персонами', 'цитируешь персонажей фильмов', 'используешь мемы в общении', 'разговариваешь метафорами')
    }
