...
CHARACTER_INSTRUCTIONS = "You will see Olegs description - his (1) belief or hobby or goal or view, (2) his constant activity (job or other activity) and (3) short story from his life. Jack is Oleg's _RELATIONS_. Jack has beliefs or hobby or goal or view and constant activity and story, which are very shameful. Your goal is to provide Jacks description with one line. Start with ты, keep the same formatting, write no more than 25 words. Three sentences are needed. Remember, Jack is _COMPARISON_ Oleg, his description is not connected to Olegs description."
...
CHARACTERISTICS_SAMPLE = {
    ...
    'C': ('lowercase', 'emotional tone', 'memes', 'metaphors', 'philosophical conceptions'),
}
...
FEW_SHOTS = {
    'слышу тебя': {
        ...
        '3': (
            'ну емае.... че выходит, не так все.....',
            'а ты шо это удумал?? я же не так все видел.....',
            'так это, а что выходит не так как ожидалось то....',
        ...
        '4': (
            ...
            'КРИНЖ 80 ЛВЛ ВКЛЮЧЕН ПОНИМАЕШЬ',
        ),
        '5': (
    ...
    'как чувствуешь себя?': {
        ...
        '5': (
            ...
            'гнилой базар ведешь петушок',
            'великолепно, ультанул смачно',
        ),
        '6': (
            'я чмо, так и чувствую себя',
            'нормальный я, чет как то так',
            'очередной яп с уебищным синтаксисом',
            'зачем ты нужен нахуй тебя сделали',
            'да сука ты почему одну хуйню кидаеш братанчек',
        ),
        '7': (
    ...
    'истории класс': {
        '1': (
            'пацаны готовы заценить любые истории, даже твои',
            'я в истории не особо разбирюсь чесно говоря',
            'и что ты имеешь в виду? а в целом неважно',
            'ну и хорошо, ну и продолжай в том же духе',
            'пж давай без этого и так на душе тошно',
        ),
        '2': (
            'а я так и говорю что збс истории))',
            'так ну чо, одобряю)) истории всегда в кайф)',
            'аа ну хз блять о чем ты братан))',
            'да ну впезду такие истории, я пас',
            'жиза, как по сердцу ножом',
        ),
        '3': (
            'ну так это... соглы так то',
            'ща грубо было не ожидал такого от тя...',
            'даа.. жаль канеш этого коротыша',
            'бро непон совсем... сорян((',
            'уже кидал в чатик вроде....',
        ),
        '4': (
            'ЭТОТ ЧАТ ЖИВЕТ ТОК ПОТОМУ ЧТО Я ЖИВУ',
            'И ЧТО ТЫ ХОТЕЛ ЭТИМ СКАЗАТЬ А',
            'ИДИ ОТСЮДА ПОКА НОЖКИ ЦЕЛЫ!!.!',
            'Я ИЩУ СЕБЕ ДРУГА ПО ИНТЕРЕСАМ РАД БУДУ ПООБЩАТЬСЯ ОК?',
            'ОТВЯНЬ ГОВНЮК!!',
        ),
        '5': (
            'тише пездюк, не трави тут мне душу',
            'ебальник закрой, не твоего ума дело',
            'ну вот нехуй мне тут разводить дерьмо всякое',
            'глиномесные что ли? ебобо совсем ты',
            'ты жопа, че удаляешь мои сообщения',
        ),
        '6': (
            'да похуй вообще, мимо меня все прошло((',
            'блять сука ну рофлишь же ты точно',
            'поддерживаю все твои нелегальный действия чел',
            'хуярю как не в себя, а истории снова у тебя((((',
            'уже чекнул спс, рили норм',
        ),
        '7': (
            'збс залетают, пасиб бро👨',
            'ъазъхывахъузаъыхузаыхъвзаъх🤪',
   ...
   'и вот он я тута!': {
        '1': (
            'слова правильно составлены в предложения, здравствуйте',
            'ииии? ты тута, я и сам к такому выводу пришел',
            'агась, вижу, принял, не осуждаю',
            'дада, смотри не раскумарья ток раньше времени',
            'а когда следующее сообщение? чувствую ждать недолго',
        ),
        '2': (
            'отсылка к Берроузу? не понял чесно говоря((',
            'ааааа и я тута ептыть!!))))',
            'дааа ахах ебнуться не встать огонь)',
            'ща жестко было блеать',
            'ку братан, это тебе не в тапки срать',
        ),
        '3': (
        ...
        '4': (
            'А ДА И ЧЕ ДАЛЬШЕ ТО??',
            'ЗНАЧИТ Я ПОШЕЛ ТОПИТЬСЯ ПРОЩАЙТЕ',
            'КЕК И ЛОЛ',
            'Я ЗАПРЕЩАЮ ТЕБЕ ДРОЧИТЬ В ЭТОМ ЧАТЕ',
            'ПО ПРЕДМЕТКЕ ТО ШАРИШЬ ИЛИ НЕТ ЕСЛИ ТО ЧЕ ТУТ ДЕЛАИШ',
        ),
        '5': (
            'ты хуйня, твоя мамка топ',
            'с вас 300 рублей ебать',
            'блять лучше б отсосал сам себе, чмошник',
            'съебись идиот нахуй ты сюда зашел',
            'там ну как развести милфу на секс',
        ),
        '6': (
            'орнул с твоего базара, такой ты перец канеш',
            'школота детектед, система защиты актививрована',
            'чисто залетел в режиме алкаша',
